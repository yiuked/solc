...
var WomTransferMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"contractEWOMToken\",\"name\":\"_ewomAddr\",\"type\":\"address\"},{\"internalType\":\"contractWomNFT\",\"name\":\"_nftAddr\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_to\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"price\",\"type\":\"uint256\"}],\"name\":\"coin\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"ewomToken\",\"outputs\":[{\"internalType\":\"contractEWOMToken\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_to\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"token\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"number\",\"type\":\"uint256\"}],\"name\":\"nft\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"seller\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"token\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"number\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"price\",\"type\":\"uint256\"}],\"name\":\"send\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"womNFT\",\"outputs\":[{\"internalType\":\"contractWomNFT\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
	Sigs: map[string]string{
		"611091a3": "coin(address,uint256)",
		"6604defc": "ewomToken()",
		"4e34390f": "nft(address,uint256,uint256)",
		"2ef140ef": "send(address,uint256,uint256,uint256)",
		"01216f01": "womNFT()",
	},
	Bin: "",
}
...
// Coin is a paid mutator transaction binding the contract method 0x611091a3.
//
// Solidity: function coin(address _to, uint256 price) returns()
func (_WomTransfer *WomTransferTransactor) Coin(opts *bind.TransactOpts, _to common.Address, price *big.Int) (*types.Transaction, error) {
	return _WomTransfer.contract.Transact(opts, "coin", _to, price)
}

// Coin is a paid mutator transaction binding the contract method 0x611091a3.
//
// Solidity: function coin(address _to, uint256 price) returns()
func (_WomTransfer *WomTransferSession) Coin(_to common.Address, price *big.Int) (*types.Transaction, error) {
	return _WomTransfer.Contract.Coin(&_WomTransfer.TransactOpts, _to, price)
}

// Coin is a paid mutator transaction binding the contract method 0x611091a3.
//
// Solidity: function coin(address _to, uint256 price) returns()
func (_WomTransfer *WomTransferTransactorSession) Coin(_to common.Address, price *big.Int) (*types.Transaction, error) {
	return _WomTransfer.Contract.Coin(&_WomTransfer.TransactOpts, _to, price)
}

// Nft is a paid mutator transaction binding the contract method 0x4e34390f.
//
// Solidity: function nft(address _to, uint256 token, uint256 number) returns()
func (_WomTransfer *WomTransferTransactor) Nft(opts *bind.TransactOpts, _to common.Address, token *big.Int, number *big.Int) (*types.Transaction, error) {
	return _WomTransfer.contract.Transact(opts, "nft", _to, token, number)
}

// Nft is a paid mutator transaction binding the contract method 0x4e34390f.
//
// Solidity: function nft(address _to, uint256 token, uint256 number) returns()
func (_WomTransfer *WomTransferSession) Nft(_to common.Address, token *big.Int, number *big.Int) (*types.Transaction, error) {
	return _WomTransfer.Contract.Nft(&_WomTransfer.TransactOpts, _to, token, number)
}

// Nft is a paid mutator transaction binding the contract method 0x4e34390f.
//
// Solidity: function nft(address _to, uint256 token, uint256 number) returns()
func (_WomTransfer *WomTransferTransactorSession) Nft(_to common.Address, token *big.Int, number *big.Int) (*types.Transaction, error) {
	return _WomTransfer.Contract.Nft(&_WomTransfer.TransactOpts, _to, token, number)
}

// Send is a paid mutator transaction binding the contract method 0x2ef140ef.
//
// Solidity: function send(address seller, uint256 token, uint256 number, uint256 price) returns()
func (_WomTransfer *WomTransferTransactor) Send(opts *bind.TransactOpts, seller common.Address, token *big.Int, number *big.Int, price *big.Int) (*types.Transaction, error) {
	return _WomTransfer.contract.Transact(opts, "send", seller, token, number, price)
}

// Send is a paid mutator transaction binding the contract method 0x2ef140ef.
//
// Solidity: function send(address seller, uint256 token, uint256 number, uint256 price) returns()
func (_WomTransfer *WomTransferSession) Send(seller common.Address, token *big.Int, number *big.Int, price *big.Int) (*types.Transaction, error) {
	return _WomTransfer.Contract.Send(&_WomTransfer.TransactOpts, seller, token, number, price)
}

// Send is a paid mutator transaction binding the contract method 0x2ef140ef.
//
// Solidity: function send(address seller, uint256 token, uint256 number, uint256 price) returns()
func (_WomTransfer *WomTransferTransactorSession) Send(seller common.Address, token *big.Int, number *big.Int, price *big.Int) (*types.Transaction, error) {
	return _WomTransfer.Contract.Send(&_WomTransfer.TransactOpts, seller, token, number, price)
}
